...
- Current combined checks: 76 tests, typecheck, build and contract 75/75 pass;
  lint has zero errors and the existing verifier warning. Public deployment
  and browser behavior remain separate evidence.
