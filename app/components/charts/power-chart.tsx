        ...
        <div className="flex items-center gap-3">
          ...
          <div className="text-right">
            ...
            <div className="text-[10px] text-zinc-400">
              Min: {formatPower(minPower)} | Max: {formatPower(maxPower)}
            </div>
          </div>
        </div>
      </div>
            ...
            {samples.length > 0 && (
              <>
                <text
                  ...
                  className="text-[10px] fill-zinc-400 font-mono"
                >
                  {formatKolkataTime(samples[0].sim_time_utc)}
                </text>
                <text
                  ...
                  className="text-[10px] fill-zinc-400 font-mono"
                >
                  {formatKolkataTime(samples[samples.length - 1].sim_time_utc)}
                </text>
              </>
            )}
        ...
        {activePoint && (
          ...
          >
            <span className="font-mono text-zinc-400">
              {formatKolkataTime(activePoint.timeUtc)}
            </span>
